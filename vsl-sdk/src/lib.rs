...
impl Amount {
    ...
    pub fn from_subunits(subunits: u128) -> Self {
        Self::from_subunits_with_decimals(subunits, 18)
    }

    pub fn from_subunits_with_decimals(subunits: u128, decimals: u8) -> Self {
    ...
    pub fn from_tokens_with_decimals(tokens: u128, decimals: u8) -> Self {
        ...
        let coins = tokens
            ...
            .unwrap_or_else(|| panic!("Speficied amount cannot be represented"));
        Self::from_subunits_with_decimals(coins, decimals)
    }
